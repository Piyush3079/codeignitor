			    ...
			    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
			      ...
			      <ul class="nav navbar-nav navbar-right">
			        ...
			        <li class="dropdown">
			          ...
			          <ul class="dropdown-menu">
			            <li><a href="<?php echo base_url().'home/me/'.$this->session->userdata('oauth_uid'); ?>">Profile</a></li>
			            ...
			            <li role="separator" class="divider"></li>
			            <li><a href="<?php echo base_url().'login/logout/'.$this->session->userdata('oauth_provider'); ?>">Logout</a></li>
			          </ul>
			        </li>
			      </ul>
			    </div><!-- /.navbar-collapse -->
