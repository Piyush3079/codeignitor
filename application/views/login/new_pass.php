		...
		<div class="container">
			<div class="row">
				...
				<div class="col-sm-6"><br><br><br><br>
					<?php echo form_open(base_url('login/pwdre'), array('id'=>'myForm', 'class'=>'form-horizontal')); ?>
						<legend>Enter New Password</legend>
					  <div class="form-group">
					    <!--<label for="email" class="col-sm-2 control-label">Email</label>-->
					    <div class="col-sm-offset-1 col-sm-10" id="email_login">
					      <input type="password" class="form-control" name="pass" id="email1" placeholder="Password" aria-describedby="inputSuccess2Status">
					    </div>
					  ...
					  <div class="form-group">
					    ...
					    <div class="col-sm-offset-1 col-sm-10" id="pass_login">
					      <input type="password" class="form-control" name="confpass" id="pass1" placeholder="Confirm Password" aria-describedby="inputSuccess2Status">
					    </div>
					  </div>
					  <input type="hidden" value="<?php echo $this->security->get_csrf_hash(); ?>" name="token" id="token">
					  <div class="col-sm-offset-1 col-sm-10">
					    	<a href="<?php echo base_url(); ?>" style="float:right;"><small>Click here to cancal.</small></a>
					    </div><br>
					  <div class="form-group">
					    <div class="col-sm-offset-5 col-sm-6">
					      <button type="submit" class="btn btn-success" id="button" name="proceed">Proceed</button>
					    </div>
					  </div>
					</form>
				</div>
