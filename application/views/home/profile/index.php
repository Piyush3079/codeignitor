<?php
	...
	if($this->session->userdata('oauth_uid') && $this->session->userdata('identity')){
		...
		if($data['data2'][0]['number'] != ''){
			...
			$data1 = '<a href="#" class="name_model">Add Number</a>';
		}
		if($data['data2'][0]['gender']){
			$data2 = $data['data2'][0]['gender'];
		}
		else{
			$data2 = '<a href="#" class="name_model">Add Gender</a>';
		}
		if($data['data2'][0]['dob']){
			$data3 = $data['data2'][0]['dob'];
		}
		else{
			$data3 = '<a href="#" class="name_model">Add Date of Birth</a>';
		}
		if($data['data2'][0]['language']){
			$data4 = $data['data2'][0]['language'];
		}
		else{
			$data4 = '<a href="#" class="name_model">Add Language</a>';
		}
		if($data['data2'][0]['living']){
			$data5 = $data['data2'][0]['living'];
		}
		else{
			$data5 = '<a href="#" class="name_model">Add Place of Living</a>';
		}
		if($data['data2'][0]['from']){
			$data6 = $data['data2'][0]['from'];
		}
		else{
			$data6 = '<a href="#" class="name_model">Where are you From?</a>';
		}
		if($data['data2'][0]['fb_link']){
			$data7 = $data['data2'][0]['fb_link'];
		}
		else{
			$data7 = '<a href="#" class="name_model">Add FB Link</a>';
		}
		...
		<div class="container" style="margin-top:70px;">
			<div>
				<div class="col-md-2" style="background: #ebe2e2;border-radius: 5px;padding:0;">
					...
					<h4 class="center-align"><a href="<?= $uid ?>" class="profile-name" style="word-wrap: break-word;"><?php echo $data['data1'][0]['first_name'].' '.$data['data1'][0]['last_name']; ?></a></h4>
					...
					<ul class="center-align" style="padding:0;list-style: none;font-size: 18px;">
						<li class="list-name1"><a href="<?php echo base_url().'home/me/'.$uid; ?>" class="ul-name1">Profile</a></li>
					...
					<div class="row">
						...
						<div class="col-md-6 profile-div1">
							...
							<div class="div-footer">
								<a href="#" class="footer-edit">Edit</a>
								<a href="#" class="footer-view">View more</a>
							</div>
						</div>
						...
						<div class="col-md-6 profile-div3">
							...
							<div class="footer-more"><a href="#">View more</a></div>
						</div>
